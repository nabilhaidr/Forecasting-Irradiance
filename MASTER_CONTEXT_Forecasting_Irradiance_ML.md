...
**M0 remains open: 2/7 tasks are fully accepted. S0-1 and S0-3 are complete; S0-2 remains 🟡 on historian confirmation.** **S0-3 decision: COMPLETE.** **S0-4 decision: consolidation delivered; 🟡 pending serial/calibration certificates and mapping/geometry confirmations.** **NO-GO for Phase 1 and all modelling.**
