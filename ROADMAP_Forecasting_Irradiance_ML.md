...
**Gate decision:** M0 is **not passed (2/7 fully accepted)**. S0-1 and S0-3 are accepted; S0-2 remains 🟡 on historian confirmation. **S0-3 decision: COMPLETE.** **S0-4 decision: consolidation delivered; 🟡 pending serial/calibration certificates and mapping/geometry confirmations.** **NO-GO for Phase 1 and for any model.**
